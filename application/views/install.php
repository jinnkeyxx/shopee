                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center mb-4">
                                <h4 class="text-uppercase mt-0">Cài đặt đầu tiên cho Admin</h4>
                            </div>
                            ...
                            <form action="" id="form-install">
                                ...
                                <div class="form-group">
                                    <label for="rp_password">Nhập lại mật khẩu</label>
                                    <input class="form-control" type="password" required="" id="rp_password"
                                        placeholder="Enter your password">
                                </div>
